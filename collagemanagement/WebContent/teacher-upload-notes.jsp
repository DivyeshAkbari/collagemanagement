                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li><a href="Teacher_dashboard.jsp"><i class="flaticon-turn-off"></i>Log Out</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                                ...
                                <form class="new-added-form">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12 form-group">
                                            ...
                                            <textarea class="textarea form-control" name="message" id="form-message" cols="10" rows="5"></textarea>
                                        </div>
                                        <div class="col-lg-4">
                                            <button type="button" class="btn-fill-lmd radius-30 text-light bg-true-v">
                                            Upload Notes Here<i class="fas fa-cloud-upload-alt mg-l-10"></i>
                                        </button></div>
