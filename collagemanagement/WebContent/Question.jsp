...
<head>
    ...
    <!--Plugin CSS-->
    <link href="@(Url.Content("css/plugin.css"))" rel="stylesheet" type="text/css">
...
<body class="page">
            ...
            <div class="blog-detail-main">
                ...
                <div class="tag mar-top-30">
                    <div class="widget-tags-main">
                        ...
                        <a href="@(Url.Content("#"))" class="" >Beach</a>
                        <a href="@(Url.Content("#"))" class="" >Dress</a>
                        <a href="@(Url.Content("#"))" class="" >Food</a>
                        <a href="@(Url.Content("#"))" class="" >Fashion</a>
                        <a href="@(Url.Content("#"))" class="" >Gadget</a>
                        <a href="@(Url.Content("#"))" class="" >Holiday</a>
                        <a href="@(Url.Content("#"))" class="" >Nature</a>
                        <a href="@(Url.Content("#"))" class="" >Photography</a>
                        <a href="@(Url.Content("#"))" class="" >Tips</a>
                        <a href="@(Url.Content("#"))" class="" >Travel</a>
                    </div>
                </div>
    ...
    <!-- Latest jquery --><script src="@(Url.Content("js/jquery-3.2.1.min.js"))"></script>
    <!-- Plugin Jquery --><script src="@(Url.Content("js/plugin.js"))"></script>
    <!-- custom nav jquery --><script src="@(Url.Content("js/custom-nav.js"))"></script>
    <!-- main default Jquery --><script src="@(Url.Content("js/main.js"))"></script>
</body>
