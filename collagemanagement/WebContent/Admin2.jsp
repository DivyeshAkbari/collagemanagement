...
<%
	...
	int count = adminpanelService.fetchactivemaleStudent();
	
	int count1 = adminpanelService.fetchactivefemaleStudent();
...
map = new HashMap<Object,Object>(); map.put("label", "ActiveMaleStudents"); map.put("y",count); list.add(map);

map = new HashMap<Object,Object>(); map.put("label", "ActiveFemaleStudents"); map.put("y",count1); list.add(map);

/* map = new HashMap<Object,Object>(); map.put("label", "ActiveFeMaleFaculties"); map.put("y",count2); list.add(map);

map = new HashMap<Object,Object>(); map.put("label", "ActiveMaleFaculties"); map.put("y",count3); list.add(map); */
