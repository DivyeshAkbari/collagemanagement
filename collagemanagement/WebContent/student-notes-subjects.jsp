...
<head>
    ...
    <title>EduChamp | Student notes</title>
                            ...
                            <div class="row align-items-center ">
                                ...
                                <div class="col-6">
                                    <div  class="item-content">
                                        <div style="font-size:2vw;" class="item-title chevron"> <h2  id="dsubvalue" value="<%= s.getSubjectId() %>"> <a href = <%= "\"FetchStudentNotes?Id=" + s.getSubjectId() +"&Name=" +s.getSubjectName()+ "\"" %>><%= s.getSubjectName() %></a> </h2>
                                        </div>
