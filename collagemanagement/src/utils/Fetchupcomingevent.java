...
/**
 * Servlet implementation class Fetchupcomingevent
 */
public class Fetchupcomingevent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Event> eventlist=adminpanelService.fetchEvent(1);
