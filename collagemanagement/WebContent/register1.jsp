					...
					<div class="row placeani">
						<div class="col-md-6">
							<div class="form-group">
								<div class="input-group">
									...
									<input autocomplete="off" name="dzName" type="text" required="" class="form-control">
								</div>
							</div>
						<!-- </div> -->
						<!-- <div class="col-lg-12"> -->
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" name="dzName" type="email" required="" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group"> 
                        ...
                        <div class="form-group">
                            <div class="input-group"> 
                                ...
                                <input id="confirm_password" autocomplete="off" name="cpsw" type="password" class="form-control" required="">
						...
						<!-- <div class="col-lg-12"> -->
							<div class="form-group">
								<div class="input-group">
									...
									<textarea name="dzName" type="email" required="" class="form-control" cols="30" rows="4"  maxlength="100" placeholder="Enter Your Address *"> </textarea>
								</div>
							</div>
						<!-- </div> -->
						<!-- <div class="col-lg-12"> -->
