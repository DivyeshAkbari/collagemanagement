                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <!-- <li class="nav-item">
                                    <a href="index.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Admin</a>
                                </li> -->
                                <li class="nav-item">
                                    <a href="Student_dashboard.jsp" class="nav-link menu-active"><i
                                            class="fas fa-angle-right"></i>Student</a>
                                </li>
                                <!-- <li class="nav-item">
                                    <a href="index4.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Parents</a>
                                </li>
                                <li class="nav-item">
                                    <a href="index5.jsp" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Teachers</a>
                                </li> -->
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="student-query.jsp" class="nav-link"><i
                                    class="flaticon-chat-comment-oval-speech-bubble-with-text-lines"></i><span>Post Query</span></a>
                        </li>
                        <li class="nav-item sidebar-nav-item">
